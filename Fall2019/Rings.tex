...
\begin{problem}
Let $p(x) = 6 x^4 - 7 x^3 + 15 x^2 - 21 x - 9$. Then 
\begin{itemize}
\item $p(x) = (2x-3)(3x+1)(x^2+3)$ and 
\item $p(x) = (x+\frac{1}{3})(2x^2+6)(3x-\frac{9}{2})$
\end{itemize}
 are two different factorizations of $p(x)$ into irreducible in $\mathbb{Q}[x]$. Explain why the factorizations are the ``same'' up to reordering the factors and multiplying each factor by a unit.
\end{problem}
