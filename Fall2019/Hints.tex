...
\begin{hint*}[Problem~\ref{prob.AutQAdjoinZeta5OverQ}]
Try following the process in Example~\ref{prob.AutQAdjoinRoot5OverQ}. Problem~\ref{prob.Cyclo5Irreducible} may be helpful.
\end{hint*}
