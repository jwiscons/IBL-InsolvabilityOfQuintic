...
You want to show that $x^{-1}y^{-1}xy \in N$, which is the same as $(x^{-1}y^{-1}xy)N = N$ in the quotient group $H/N$. Work in $H/N$, and compute $(x^{-1}N)(y^{-1}N)(xN)(yN)$. Don't forget that $H/N$ is abelian.
\end{hint*}
